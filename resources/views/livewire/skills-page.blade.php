<section class="container mx-auto px-6 py-12">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        @forelse ($skills as $skill)
            <a href="{{ localized_route('skill.detail', ['slug' => \Illuminate\Support\Str::slug($skill->name)]) }}" class="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow flex items-center space-x-4">
