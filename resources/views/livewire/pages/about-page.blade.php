        ...
        <div class="grid lg:grid-cols-5 gap-16">
            ...
            <div class="lg:col-span-2 space-y-5">
                ...
                <x-about-card :title="__('messages.about_availability_label')" class="reveal reveal-delay-2">
                    ...
                    <div class="space-y-2.5">
                        <div class="flex items-center justify-between">
                            <span class="text-xs text-slate-400 dark:text-slate-500">{{ __('messages.availability_status') }}</span>
                    ...
                    {{ __('messages.availability_available') }}
                        ...
                        <div class="flex items-center justify-between">
                            <span class="text-xs text-slate-400 dark:text-slate-500">{{ __('messages.availability_type') }}</span>
                            <span class="text-xs font-semibold text-slate-700 dark:text-slate-300">{{ __('messages.availability_type_value') }}</span>
                        </div>
                        <div class="flex items-center justify-between">
                            <span class="text-xs text-slate-400 dark:text-slate-500">{{ __('messages.availability_timezone') }}</span>
                            <span class="text-xs font-semibold text-slate-700 dark:text-slate-300">CET (UTC+1)</span>
                        </div>
                        <div class="flex items-center justify-between">
                            <span class="text-xs text-slate-400 dark:text-slate-500">{{ __('messages.availability_response') }}</span>
                            <span class="text-xs font-semibold text-slate-700 dark:text-slate-300">{{ __('messages.availability_response_value') }}</span>
                        </div>
                    </div>
                </x-about-card>
                ...
                <x-about-card :title="__('messages.about_open_to_label')" class="reveal reveal-delay-3">
                    ...
                    <div class="space-y-2">
                        @foreach([
                            ...
                            __('messages.open_to_consulting'),
                        ] as $item)
                ...
                <x-about-card :title="__('messages.about_exploring_label')" class="reveal reveal-delay-2">
                    ...
                    <div class="flex flex-wrap gap-2">
                        @foreach(['Docker', 'Filament', 'TDD'] as $tech)
                    ...
                    <div class="space-y-3">
                        @foreach([
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    <div class="text-xs font-semibold text-slate-700 dark:text-slate-200 leading-snug">{{ $course }}</div>
                ...
                >
                    ...
                    <div class="space-y-6 relative before:absolute before:left-[7px] before:top-2 before:bottom-2 before:w-px before:bg-slate-200 dark:before:bg-white/10">
                        ...
                        <button @click="open = !open" type="button"
                                class="group inline-flex items-center text-sm font-semibold text-indigo-600 dark:text-indigo-400 transition-colors duration-200">
                            <span x-text="open ? '{{ __('messages.show_less') }}' : '{{ __('messages.show_more_education') }}'"></span>
                            <span class="inline-block w-4 ml-2 overflow-visible">
                    <svg class="w-4 h-4 transition-transform duration-200"
                         :class="open ? 'rotate-180' : 'group-hover:translate-y-0.5'"
                         fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
