    ...
    @section('content')
        <section class="container mx-auto px-6 py-12">
            ...
            <form wire:submit.prevent="submit" class="max-w-lg mx-auto space-y-6">
                ...
                <!-- Message -->
                <div>
                    <label for="message" class="block text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('messages.contact_message_label') }}</label>
                    <textarea id="message" wire:model="message" rows="5" class="mt-1 block w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:text-white"></textarea>
