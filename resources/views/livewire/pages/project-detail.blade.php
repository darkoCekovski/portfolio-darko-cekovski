    ...
    <span class="inline-block w-4 mr-2 overflow-visible">
        <svg class="w-4 h-4 transition-transform duration-200 group-hover:-translate-x-1.5" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
            ...
            <div class="rounded-2xl overflow-hidden mb-10 reveal reveal-delay-2">
                <img src="{{ $project->thumbnail }}" alt="{{ $project->title }}" class="w-full object-cover max-h-[460px]">
            </div>
            @endif
            ...
            <div class="grid lg:grid-cols-3 gap-10">
                ...
                <div class="space-y-6 reveal reveal-delay-3">
                    <div class="p-5 rounded-2xl bg-white dark:bg-white/[0.03] border border-slate-200 dark:border-white/[0.08]">
                        ...
                        <div class="flex flex-wrap gap-2">
                            ...
                            <span class="px-2.5 py-1 text-xs rounded-lg bg-indigo-50 dark:bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 font-semibold border border-indigo-100 dark:border-indigo-500/20">
                                {{ $tech }}
                            </span>
                            @endforeach
                        </div>
