                        ...
                        @if($project->demo_url)
                            <div class="flex items-center gap-2">
                                ...
                                <a href="{{ $project->demo_url }}" target="_blank" rel="noopener"
                                   class="text-sm font-semibold text-accent-600 dark:text-accent-400 hover:underline truncate">
                                    {{ __('messages.badge_live') }}
                                </a>
                            </div>
                        @else
                            <div class="flex items-center gap-2">
                                <svg class="w-4 h-4 text-highlight-500 flex-shrink-0" fill="none" stroke="currentColor"
                                     stroke-width="2" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                          d="M12 6v6h4.5m4.5 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0z"/>
                                </svg>
                                <span class="text-sm font-semibold text-highlight-600 dark:text-highlight-400">
