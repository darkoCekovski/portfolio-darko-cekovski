            ...
            @forelse($projects as $i => $project)
                <a href="{{ localized_route('project.detail', ['id' => $project->id]) }}"
                   class="group rounded-2xl bg-white dark:bg-white/[0.03] border border-slate-200 dark:border-white/[0.08]
                    ...
                    @else
                        <div
                            class="aspect-video bg-gradient-to-br from-indigo-500/10 to-sky-500/10 dark:from-indigo-500/20 dark:to-sky-500/20 flex items-center justify-center">
                            <span
                                class="text-4xl font-black text-indigo-300 dark:text-indigo-600">{{ substr($project->title, 0, 1) }}</span>
                        </div>
                    @endif
                    <div class="p-5">
