        ...
        @foreach ($skills as $skill)
            ...
            <a href="{{ $href }}"
               class="group flex flex-col items-center gap-3">
                <div
                    class="relative grid place-items-center w-40 h-40 select-none"
                    role="progressbar"
                ...
                >
                    ...
                    @if ($skill->logo)
                        <img src="{{ asset($skill->logo) }}" alt="{{ $skill->name }} Logo" class="relative w-24 h-24 opacity-90 group-hover:opacity-100 transition-opacity" loading="lazy">
                    @endif
