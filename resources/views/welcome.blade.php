        ...
        <style>
            ...
            @layer theme {
                :root, :host {
                    ...
                    --color-highlight-50: oklch(.987 .022 95.277);
                    --color-highlight-100: oklch(.962 .059 95.617);
                    --color-highlight-200: oklch(.924 .12 95.746);
                    --color-highlight-300: oklch(.879 .169 91.605);
                    --color-highlight-400: oklch(.828 .189 84.429);
                    --color-highlight-500: oklch(.769 .188 70.08);
                    --color-highlight-600: oklch(.666 .179 58.318);
                    --color-highlight-700: oklch(.555 .163 48.998);
                    --color-highlight-800: oklch(.473 .137 46.201);
                    --color-highlight-900: oklch(.414 .112 45.904);
                    --color-highlight-950: oklch(.279 .077 45.635);
                    ...
                    --color-accent-50: oklch(.977 .013 236.62);
                    --color-accent-100: oklch(.951 .026 236.824);
                    --color-accent-200: oklch(.901 .058 230.902);
                    --color-accent-300: oklch(.828 .111 230.318);
                    --color-accent-400: oklch(.746 .16 232.661);
                    --color-accent-500: oklch(.685 .169 237.323);
                    --color-accent-600: oklch(.588 .158 241.966);
                    --color-accent-700: oklch(.5 .134 242.749);
                    --color-accent-800: oklch(.443 .11 240.79);
                    --color-accent-900: oklch(.391 .09 240.876);
                    --color-accent-950: oklch(.293 .066 243.157);
                    --color-secondary-50: oklch(.97 .014 254.604);
                    --color-secondary-100: oklch(.932 .032 255.585);
                    --color-secondary-200: oklch(.882 .059 254.128);
                    --color-secondary-300: oklch(.809 .105 251.813);
                    --color-secondary-400: oklch(.707 .165 254.624);
                    --color-secondary-500: oklch(.623 .214 259.815);
                    --color-secondary-600: oklch(.546 .245 262.881);
                    --color-secondary-700: oklch(.488 .243 264.376);
                    --color-secondary-800: oklch(.424 .199 265.638);
                    --color-secondary-900: oklch(.379 .146 265.522);
                    --color-secondary-950: oklch(.282 .091 267.935);
                    --color-primary-50: oklch(.962 .018 272.314);
                    --color-primary-100: oklch(.93 .034 272.788);
                    --color-primary-200: oklch(.87 .065 274.039);
                    --color-primary-300: oklch(.785 .115 274.713);
                    --color-primary-400: oklch(.673 .182 276.935);
                    --color-primary-500: oklch(.585 .233 277.117);
                    --color-primary-600: oklch(.511 .262 276.966);
                    --color-primary-700: oklch(.457 .24 277.023);
                    --color-primary-800: oklch(.398 .195 277.366);
                    --color-primary-900: oklch(.359 .144 278.697);
                    --color-primary-950: oklch(.257 .09 281.288);
