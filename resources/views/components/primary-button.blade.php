...
@php
    $classes = match(true) {
        ...
        $size === 'sm'                            => 'inline-flex items-center gap-2 h-10 px-5 rounded-xl font-semibold text-sm bg-indigo-600 hover:bg-indigo-700 text-white shadow-sm shadow-indigo-500/20 transition-all duration-200 hover:-translate-y-0.5',
