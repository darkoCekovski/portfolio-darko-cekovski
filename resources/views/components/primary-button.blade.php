...
@php
    $classes = match(true) {
        ...
        $variant === 'amber' && $size === 'sm'    => 'inline-flex items-center gap-2 h-10 px-5 rounded-xl font-semibold text-sm bg-amber-500 hover:bg-amber-600 text-white shadow-sm shadow-amber-500/20 transition-all duration-200 hover:-translate-y-0.5',
        $variant === 'amber'                      => 'inline-flex items-center gap-2 h-11 px-6 rounded-xl font-semibold text-sm bg-amber-500 hover:bg-amber-600 text-white shadow-lg shadow-amber-500/25 transition-all duration-200 hover:-translate-y-0.5',
