...
// About
    ...
    'edu_academy_bullets' => [
        'Erstellung und Gestaltung responsiver Websites mit HTML, CSS, Flexbox, CSS Grid und Bootstrap.',
...
// Experience
    ...
    'exp_fireswitch_bullets' => [
        ...
        'Vollständig remote in einem internationalen Team gearbeitet und kontinuierlich hochwertige Features geliefert.',
        'Fokus auf sauberen, wartbaren Code und exzellente Nutzererfahrung.',
    ],
    'exp_freelance_bullets' => [
        'Individuelle Webanwendungen für Kunden mit Full-Stack Laravel entwickelt.',
...
// Earlier career — titles & companies
    ...
    'exp_role_sales' => 'Vertriebsspezialist',
    'exp_role_sales_co' => 'Vip-Plast DOOEL · Skopje · 05/2012 – 03/2016',
    'exp_role_prod_manager' => 'Produktionsleiter',
...
// Earlier career — bullet arrays
    ...
    'exp_role_production_malta_bullets' => [
        'Unterstützung beim Aufbau einer neuen Produktionslinie und deren laufender Verbesserung.',
        'Aktive Mitarbeit im täglichen Produktionsbetrieb.',
    ],
    'exp_role_sales_bullets' => [
        'Festlegung von Verkaufszielen und Durchführung von Produktdemonstrationen für Kunden.',
        'Bearbeitung von Reklamationen und Aufbau langfristiger, vertrauensvoller Kundenbeziehungen.',
    ],
    'exp_role_prod_manager_bullets' => [
        'Leitung des Produktionsteams und Organisation des gesamten Produktionsablaufs.',
        'Planung und Anpassung von Zeitplänen zur Einhaltung von Qualitätsstandards und Lieferterminen.',
    ],
...
// Continuous Learning
    ...
    'projects_all_cta' => 'Alle Projekte',
    'project_detail_tech' => 'Technologien',
    'project_detail_demo' => 'Live-Demo',
    'project_detail_github' => 'Auf GitHub ansehen',
    'project_detail' => 'Details ansehen',
    'project_description' => 'Über dieses Projekt',
    ...
    'contact_response_note' => '⚡ Ich antworte in der Regel innerhalb von 24 Stunden. Ich freue mich darauf, von deinem Projekt zu hören!',
    ...
    'contact_message_placeholder' => 'Erzähl mir von deinem Projekt…',
    ...
    'contact_email_required' => 'Bitte gib deine E-Mail-Adresse ein.',
    'contact_email_invalid' => 'Bitte gib eine gültige E-Mail-Adresse ein.',
    'contact_email_max' => 'Deine E-Mail darf 255 Zeichen nicht überschreiten.',
